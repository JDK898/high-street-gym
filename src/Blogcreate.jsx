    ...
    return (
        <>
            ...
            <section className="flex flex-row max-md:flex-wrap-reverse max-md:justify-evenly">
                <form className="flex ml-40 mt-20 flex-col justify-around basis-2/3 md:m-10">
                ...
                <img src="src\assets\image-solid.svg" alt="" className="max-w-xs max-md:max-w-80 mr-60 mt-20 max-md:mt-10 max-md:align-middle max-md:mr-0"/>
            </section>
            <Footer />
        </>
